...
tags:
  ...
  - 미즈호은행
sources:
  - "https://www.jp-bank.japanpost.jp/kojin/koza/kj_koza01.html"
  - "https://www.jp-bank.japanpost.jp/"
  - "https://www.nta.go.jp/life/juminzei/juminhyo.htm"
  - "https://www.fsa.go.jp/"
citeSources:
  - label: "ゆうちょ銀行 口座開設のご案内"
    url: "https://www.jp-bank.japanpost.jp/kojin/koza/kj_koza01.html"
  - label: "국세청 — 주민표(住民票) 제도 안내"
    url: "https://www.nta.go.jp/life/juminzei/juminhyo.htm"
  - label: "금융청(金融庁) 공식 홈페이지"
...
전국 어디에서나 지점을 찾기 쉽고, 처음 일본에 온 사람도 비교적 무난하게 계좌를 개설할 수 있습니다.<sup class="source-ref"><a href="#source-1" id="cite-1">1</a></sup>
...
| 서류 | 비고 |
|---|---|
| 재류카드 | 필수. 주소 변경 완료 상태여야 함<sup class="source-ref"><a href="#source-1">1</a></sup> |
| 여권 | 일부 은행 요구 |
| 주민표 | 전입신고 후 발급 가능 |
...
주민등록(전입신고) 없이 은행을 먼저 방문했다가 거절당하는 경우가 있습니다.<sup class="source-ref"><a href="#source-2" id="cite-2">2</a></sup> 주민등록이 선행 조건이라는 점은 미리 기억해두시면 좋습니다.
...
이 글은 일본에서 유초은행, 미즈호은행, MUFG를 직접 이용하며 느낀 경험을 바탕으로 작성했습니다. 은행 계좌 개설 기준, 필요 서류, 심사 방식은 은행·지점·재류자격·고용 상태에 따라 달라질 수 있습니다.<sup class="source-ref"><a href="#source-3" id="cite-3">3</a></sup> 실제 방문 전에는 각 은행의 최신 안내를 확인하시기 바랍니다.
