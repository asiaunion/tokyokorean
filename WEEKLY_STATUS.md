...
| 필드 | 값 |
|------|-----|
| 최종 업데이트 | 2026-06-25 (Joseph GSC URL 색인 요청 완료) |
| 프로젝트명 | TokyoKorean |
| 상태 | 🟢 AdSense 신청 대기 — GSC 색인 요청 ✅ · **ogImage 20/20** · A15/B5 |
| 목표 + 기한 | AdSense 신청 (2026-07-13~15, 플랜 B) |
| 이번 주 최우선 액션 | `garbage-disposal` 본문 1장 · healthcare 사진 · 미커밋 텍스트 배포 |
| 다음 체크포인트 | garbage 사진 → AdSense 신청 (7/13~15) |
| 블로커 | garbage 본문 0장 · 미커밋 텍스트 보강 9편 |
