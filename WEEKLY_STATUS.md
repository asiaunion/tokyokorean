...
| 최종 업데이트 | 2026-07-18 |
| 프로젝트명 | TokyoKorean |
| 상태 | 🟡 AdSense **게이트B 대기** — D-001 Cursor개정: 색인≥70%+유입2주 시 **선신청 허용**. 절대20건 폐기 |
| 목표 + 기한 | 발행 포스트 색인 ≥70% + 네이버/다음 레퍼럴 2주 → 게이트B |
| 이번 주 최우선 액션 | 게시물 GSC 색인 요청 + 네이버/티스토리 배포 (NAVER_DAUM_BACKLINK_STRATEGY) |
| 다음 체크포인트 | 색인 커버리지% 주간 기록 · 게이트B 충족 시 신청 |
| 블로커 | 없음 |
