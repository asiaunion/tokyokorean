...
| 필드 | 값 |
|------|-----|
| 최종 업데이트 | 2026-06-24 (Phase 2A 완료) |
| 프로젝트명 | TokyoKorean |
| 상태 | 🟠 AdSense 준비 중 — GSC ✅ · Phase 2A ✅ · 사진 0/61 |
| 목표 + 기한 | AdSense 신청 (2026-07-13~15, 플랜 B) |
| 이번 주 최우선 액션 | Joseph: GSC sitemap 48h 재확인 · **루트 A** 촬영 → Phase 2B |
...
| `docs/CLAUDE_HANDOFF_20260624.md` | **Claude 인수인계** (세션 시작 시 필독) |
