...
| 필드 | 값 |
|------|-----|
| 최종 업데이트 | 2026-06-25 (weekend·NEXPECT 사진 반영 — ⭐⭐⭐ 6/6) |
| 프로젝트명 | TokyoKorean |
| 상태 | 🟡 AdSense 신청 임박 — 기술·신뢰도 ✅ · **ogImage 13/20 · 본문 25건** · ⭐⭐⭐ **6/6** ✅ |
| 목표 + 기한 | AdSense 신청 (2026-07-13~15, 플랜 B) |
| 이번 주 최우선 액션 | Joseph **GSC URL 색인 10건** (~7/10) |
| 다음 체크포인트 | GSC 색인 → AdSense 신청 (7/13~15) |
| 블로커 | GSC URL 색인 미요청 · ogImage 없는 6편 (요코하마 사진 등 잔여) |
...
| 포스트 **실제 이미지** 삽입 | 🟡 2차 진행 | **ogImage 13/20 · 본문 25건** · ⭐⭐⭐ **6/6** — [`PHOTO_NEEDED_TRACKER.md`](docs/PHOTO_NEEDED_TRACKER.md) |
...
| AdSense 신청 | ⏳ 7/13~15 | 승인률 추정 **78~85%** — [`ADSENSE_AND_GSC_CHECKLIST.md`](docs/ADSENSE_AND_GSC_CHECKLIST.md) |
...
| 지표 | 현재 (6/25) |
|------|-------------|
| ogImage (히어로) | **13 / 20** (65%) |
| 본문 이미지 참조 | **25건** (깨진 링크 0) |
| ⭐⭐⭐ 6편 게이트 | **6 / 6** ✅ |
